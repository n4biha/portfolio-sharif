...
export const SMISKI_CHARACTERS = [
  ...
  // nudged right so it still overhangs the viewport edge (and reads as hiding
  // behind it) at the desktop 80% scale, where its vw-based width shrinks but
  // its %-based left anchor doesn't
  { id: "peeking", dims: [319, 707], left: "95.5%", top: "36%", tabletLeft: "95%", tabletTop: "37%", mobileLeft: "94%", mobileTop: "38%", width: "clamp(72px, 7vw, 140px)", mobileWidth: "22vw", rotation: 0, z: 5, idle: "peek", reaction: "hide", entry: [40, 0], draggable: false },
