...
import { Nunito, Anton, Courier_Prime, Caveat, Bungee, Bricolage_Grotesque, Oswald, Bebas_Neue, Inter, Fredoka, Patrick_Hand } from "next/font/google";
...
// Neat print handwriting for the desktop nav links
const patrickHand = Patrick_Hand({ variable: "--font-nav", subsets: ["latin"], weight: "400" });
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${nunito.variable} ${anton.variable} ${courier.variable} ${caveat.variable} ${bungee.variable} ${bricolage.variable} ${oswald.variable} ${bebas.variable} ${inter.variable} ${fredoka.variable} ${patrickHand.variable} h-full antialiased`}
    >
